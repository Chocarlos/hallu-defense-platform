    ...
    *,
    ...
    _require(
        approval_doc_text,
        {
            ...
            "only `hmac-sha256:` can produce a production execution grant",
    ...
    _require(
        approval_service_text,
        {
            ...
            "hmac.new",
            "A keyed approval queue cannot approve a legacy unkeyed tool-call commitment",
            "_resolve_commitment_key",
